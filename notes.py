...
if __name__ == '__main__':
    ...
    palette.setColor(QPalette.WindowText, QColor(63, 255, 34))
    palette.setColor(QPalette.ButtonText, QColor(63, 255, 34))
    palette.setColor(QPalette.Text, QColor(63, 255, 34))
